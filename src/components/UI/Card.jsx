...
export default function Card({ title, image, rating }) {
  return (
    <div className='w-[240px] sm:h-[408px] lg:w-[282px] lg:h-[480px] aspect-[0.5875] cursor-pointer transition-all duration-300 ease-out hover:scale-105 hover:mx-2 bg-neutral-800/80 rounded-xl overflow-hidden pt-2 pb-4 px-2'>
      <div className='relative w-full h-auto sm:w-[226px] sm:h-[340px] md:w-[200px] md:h-[301px] lg:w-[266px] lg:h-[400px] aspect-[0.665] rounded-lg overflow-hidden transition-transform duration-300 ease-out group-hover:scale-100 mx-auto mb-4'>

...
export default function Navbar({ isScrolled }) {
  ...
  return (
    <>
      <nav className={`fixed top-0 inset-x-0 z-30 ${isScrolled ? 'bg-neutral-800/40 backdrop-blur-md' : ''} flex justify-between items-center py-4 px-2.5 sm:px-4 lg:px-8 xl:px-32`}>
